...
export function registerDashboardRoutes(
  api: Pick<OpenClawPluginApi, "registerHttpRoute">,
  store: CreditsStore,
  ...
  const registerRoute = (route: Parameters<OpenClawPluginApi["registerHttpRoute"]>[0]) => api.registerHttpRoute(route);
